...
public class CartServiceImplTest {
	...
	public void initialize() {
		...
		customer = new Customer("C101", "Riya", "Patel", 22, "Female", "9236142754", add, "riyap23@domain.com");
		...
		foodCart1 = new FoodCart("FC101", customer, itemList2);
		foodCart2 = new FoodCart("FC101", customer, itemList1);
		foodCart3 = new FoodCart("FC101", customer, itemList3);
	}
	...
	void addItemToCartTest() {
		...
		assertThat(service.addItemToCart(foodCart1, item1)).isEqualTo(foodCart2);
	}
	...
	void IncreaseQuantityTest() {
		...
		assertThat(service.IncreaseQuantity(foodCart2, item1, 50)).isEqualTo(foodCart3);
	...
	void DecreaseQuantityTest() {
		...
		assertThat(service.reduceQuantity(foodCart3, item1, 50)).isEqualTo(foodCart2);
	}

	@Test
	void removeItemTest() {
		Mockito.when(repository.save(foodCart2)).thenReturn(foodCart2);
		assertThat(service.removeItem(foodCart2, item1)).isEqualTo(foodCart1);
	}

	@Test
	void clearCartTest() {
		Mockito.when(repository.save(foodCart2)).thenReturn(foodCart2);
		assertThat(service.clearCart(foodCart2)).isEqualTo(foodCart1);
	}
