...
public class ICategoryController {
	...
	@GetMapping(value = "/view/{catId}")
	public ResponseEntity<Category> viewCategory(@PathVariable String catId) {
		Category showCategory = service.viewCategory(service.viewCategoryById(catId));
